...
- Create Angular project with ng: `ng new joborchestrator.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`joborchestrator.client.esproj`).
